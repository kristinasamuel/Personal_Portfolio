    ...
    <section id="about" className="bg-black text-white py-20">
      <div className="container mx-auto p-8">
        ...
        <p className="text-lg text-center leading-relaxed max-w-3xl mx-auto">
          I am Kristina, a passionate Full Stack AI Developer focused on creating modern, interactive, and user-friendly web applications. I enjoy transforming ideas into polished digital experiences and building intelligent workflows and chatbots that solve real-world problems. Each project reflects my creativity, continuous learning, and dedication to delivering impactful solutions.
        </p>
        ...
        <div className="my-16">
          ...
          <ul className="list-disc list-inside max-w-3xl mx-auto space-y-4 text-lg">
            ...
            <li>Currently expanding skills in <strong>Full Stack AI development</strong>, automation workflows, AI-based tooling, and scalable architecture.</li>
          </ul>
        </div>
      </div>
    </section>
